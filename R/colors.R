...
rtist_palettes <- list(
    ...
    picasso1 = c("#4E7989", "#A9011B", "#E4A826", "#80944E", "#DCD6B2"),
    picasso2 = c("#CD6C74", "#566C7D", "#DD9D91", "#A1544B", "#D5898D"),
    pollock = c("#D89CA9", "#1962A0", "#F1ECD7", "#E8C051", "#1A1C23"),
    prince = c("#735bcc", "#6650b4", "#59449c", "#4b3984", "#3e2d6c"),
    quidor = c("#B79A59", "#826C37", "#54442F", "#DBCEAF", "#C4AA52"),
